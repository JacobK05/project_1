...
async function convertZipAndFindRestaurantsAndHotels() {
  ...
  try {
      ...
      const { Latitude, Longitude } = latLongData[0];
      ...
      const hotelUrl = `https://tripadvisor16.p.rapidapi.com/api/v1/hotels/searchHotelsByLocation?latitude=${Latitude}&longitude=${Longitude}&checkIn=${checkInDate}&checkOut=${checkOutDate}&pageNumber=1&currencyCode=USD&amenities=restaurant`;
